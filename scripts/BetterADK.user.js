...
(function() {
    ...
    */
    ...
    // small part designed for franime only
        ...
        waitForElm('.flex.items-center.gap-2.rounded-lg.bg-primary-default.px-6.py-3.text-white.transition-all.duration-200').then((elm) => {
                    ...
                    waitForElm('#malEpisodes').then((elm) => {
                        ...
                        waitForElm('#watchlist-actuel').then((elmButton) => {
                            ...
                            if (window.location.href.includes("updatelist=true")) {
                                ...
                                setTimeout(closeOrReload, 10000);
                                ...
                                let interval = setInterval(() => {
                                    if (elm.value != 0) {
                                        ...
                                        let intervalAgain = setInterval(() => {
                                            let loader = document.getElementById("watchlist-loading");
